...
#Changelog
* Added support for almost all audio files that Windows Media Player supports.
* Fixed a bug where the preview button for Abandoned Temple was not being saved properly. 